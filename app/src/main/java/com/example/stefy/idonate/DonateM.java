...
public class DonateM extends AppCompatActivity {
    InputStream is=null;
    String result=null;
    String line=null;
    String[] name;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donate_m);
        setTitle("Δωρεά Φαρμάκων");
    ...
    public void onClickButtonNext(View view){
        ...
        val.setCategoryInsert("medicine_data");
        if (val.getQuantity().equals("")){
    ...
    private void myMethod(){
        try{
            ...
            HttpPost httpPost = new HttpPost(val.getMyPath()+"/papariga/android/medicineitems.php");
        ...
        try{
            ...
            ArrayAdapter<String> dataAdapter1=new ArrayAdapter<String>(DonateM.this,android.R.layout.simple_spinner_item,name);
