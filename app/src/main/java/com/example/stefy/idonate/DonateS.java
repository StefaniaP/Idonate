...
public class DonateS extends AppCompatActivity {
    ...
    private void myMethod(){
        try{
            ...
            HttpPost httpPost = new HttpPost(val.getMyPath()+"/papariga/android/shoesitems.php");
        ...
        try{
            ...
            ArrayAdapter<String> dataAdapter1=new ArrayAdapter<String>(DonateS.this,android.R.layout.simple_spinner_item,name);
